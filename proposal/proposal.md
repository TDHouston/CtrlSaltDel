...
- [X] Create and style About Us page (~30min)
...
- [X] Implement FETCH for users to view favorited recipes + their own recipes, replace dummy data (~45min)
- [X] Implement ability for users to add upvotes (~45min)
- [ ] Implement admin ability to add, delete, edit categories on user page (~2hr)
- [ ] Implement admin ability to delete comments (~45min)
- [X] Implement admin ability to delete users (~45min)
